    ...
    <LinearGradient colors={["#fff5f8", "#ffe4f0"]} style={{ flex: 1 }}>
      ...
      <View className="flex-row justify-end px-4 pt-14">
        <TouchableOpacity
          ...
          className="px-4 py-2"
        >
          <Text className="text-[#ee2b8c] font-semibold text-sm">Skip</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="items-center px-8 pt-8 pb-4">
        <Text className="text-[34px] font-extrabold text-[#181114] text-center tracking-tight">
          Welcome to Her Circle
        </Text>
        <Text className="text-lg font-medium text-[rgba(24,17,20,0.7)] text-center mt-4 leading-7 max-w-[300px]">
      ...
      <View className="px-6 pb-12 gap-4">
        ...
        <TouchableOpacity className="items-center py-2" onPress={() => router.push("/auth/login")}>
          <Text className="text-[rgba(24,17,20,0.6)] font-semibold text-xs">
